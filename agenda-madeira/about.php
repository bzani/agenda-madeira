  ...
  <div class="row">
    ...
    <div class="col-sm-5">
      <p align='left'>
        ...
        em uma interface amigável e responsiva, em formato de agenda de contatos, além disso,
        conta com recursos gráficos para aprimorar a análise e gestão de sua base de dados.<br>
